...
\begin{cvpubs}
  \cvpub
    {
      \begin{cvetar}
      \item {Palomo-Muñoz, G, \textbf{T.J. Werdel}, C.W. Piper, M.S. Peek, A.M. Ricketts, and A.A Ahlers. \textbf{In-Press}. Spatiotemporal distributions of mammals occurring in an agro-prairie ecosystem. \textbf{\textit{Ecology}}.}
  ...
  \cvpub
    {
      ...
      \item {\textbf{Werdel, T.J.}, J.A. Jenks, J.T. Kanta, C.P. Lehman, and T.J. Frink. \textbf{In-Revision}. Resource selection and herbaceous biomass at foraging sites of translocated bighorn sheep. \textbf{\textit{Rangeland Ecology and Management}}.}
      \item {\textbf{Werdel, T.J.}, C.W. Piper, A.M. Ricketts, M.S. Peek, D.S. Sullins, and A.A Ahlers. \textbf{In-Revision}. Strategic grassland conservation to improve conservation outcomes for swift foxes in a multi-use landscape. \textbf{\textit{Biological Conservation}}.}
