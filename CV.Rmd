...
\begin{cvpubs}
  \cvpub
    {
      \begin{cvetar}
      \item {Hessami, M.A., \textbf{T.J. Werdel}, S.J. Hoagland, and M.T. Kohl. \textbf{In-Press}. Melding Past, Present, and Future: The importance of tribal management in wildlife conservation and management. Chapter 1 in E. Gomez, C. Bishop, Ryder, and Organ eds. \textbf{\textit{Wildlife Management and Conservation in North America: An Overview}}. Great River Learning of Dubuque, IA.}
...
\begin{cvpubs}
  \cvpub
    {
      \begin{cvetar}
      \item {Palomo-Muñoz, G, \textbf{T.J. Werdel}, C.W. Piper, M.S. Peek, A.M. Ricketts, and A.A Ahlers. \textbf{In-Revision}. Spatiotemporal distributions of mammals occurring in an agro-prairie ecosystem. \textbf{\textit{Ecology}}.}
      \item {\textbf{Werdel, T.J.}, C.W. Piper, A.M. Ricketts, M.S. Peek, and A.A Ahlers. \textbf{In-Revision}. Landscape-scale effects structure carnivore communities in an agro-prairie ecosystem. \textbf{\textit{Journal of Mammalogy}}.}
      ...
      \item {\textbf{Werdel, T.J.}, J.A. Jenks, J.T. Kanta, C.P. Lehman, and T.J. Frink. \textbf{In-Review}. Resource selection and herbaceous biomass at foraging sites of translocated bighorn sheep. \textbf{\textit{Rangeland Ecology and Management}}.}
      ...
      \item {\textbf{Werdel, T.J.}, C.W. Piper, A.M. Ricketts, M.S. Peek, D.S. Sullins, and A.A Ahlers. \textbf{In-Review}. Strategic grassland conservation to improve conservation outcomes for swift foxes in a multi-use landscape. \textbf{\textit{Biological Conservation}}.}
      \end{cvetar}
    }
\end{cvpubs}
```
...
\begin{cvpubs}
  \cvpub
    {
      \begin{cvetar}
      \item {\textbf{Department of Rangeland, Wildlife and Fisheries Management}. 2023-2024. Long-term wildlife monitoring for unmanaged rangelands transitioning to planned grazing management. \textbf{\$85,000}. Co-PIs: Stephen L. Webb and \textbf{Ty J. Werdel}.}
