...
\begin{cvpubs}
  \cvpub
    {
      \begin{cvetar}
      \item {\textbf{Werdel, T.J.}, C.W. Piper, A.M. Ricketts, M.S. Peek, D.S. Sullins, and A.A Ahlers. \textbf{In-Press}. Strategic grassland conservation to improve conservation outcomes for swift foxes in a multi-use landscape. \textbf{\textit{Biological Conservation}}.}
