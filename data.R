...
certifications <- tribble(
  ~area, ~accomplishment, ~year, ~where, ~detail,
  "Certified Wildlife Biologist®", "The Wildlife Society", "2024", "Bethesda, MD", NA,
  "Certified Peer Reviewer", "Elsevier Researcher Academy", "2024", "Amsterdam, NL", NA,
  "Esri Academy ArcGIS (9 Certifications)", "Environmental Systems Research Institute", "2021", "Redlands, CA", NA,
  "Professional Certification in Data Analysis for Life Sciences (R)", "HarvardX, Harvard University", "2020", "Cambridge, MA", NA,
  ...
  "Associate Wildlife Biologist®", "The Wildlife Society", "2016", "Bethesda, MD", NA,
...
service <- tribble(
  ...
  "Director", "Native Student Professional Development Grant", NA, 2018, NA, 2023, "The Wildlife Society", NA,
...
teach <- tribble(
  ~area, ~accomplishment, ~year, ~where, ~detail,
  "Texas A&M University", "Instructor", "2022 -- Present", "College Station, TX", "Wildlife Tracks & Sign, RWFM 402 & RWFM 602",
  "Texas A&M University", "Instructor", "2022 -- Present", "College Station, TX", "Techniques of Wildlife Management, RWFM 408 & RWFM 608",
  "Texas A&M University", "Instructor", "2022 -- Present", "College Station, TX", "Special Topics in Traditional Ecological Knowledge, RWFM 689",
...
guest <- tribble(
  ~area, ~accomplishment, ~year, ~where, ~detail,
  "Professional Wildlife Certification", "RWFM 481 - Texas A&M University", "Spring 2025", "College Station, TX", NA,
  "Professional Wildlife Certification", "RWFM 481 - Texas A&M University", "Fall 2024", "College Station, TX", NA,
  "Foundations in Rangeland, Wildlife, and Fisheries Management", "RWFM 661 - Texas A&M University", "2024", "College Station, TX", NA,
  "Ag Communication in Wildlife Research", "ALEC 350 - Texas A&M University", "2024", "College Station, TX", NA,
  "Professional Wildlife Certification", "RWFM 481 - Texas A&M University", "Spring 2024", "College Station, TX", NA,
  ...
  "Professional Wildlife Certification", "RWFM 481 - Texas A&M University", "Fall 2023", "College Station, TX", NA,
  "Occupancy Models to Study Wildlife", "RWFM 689 - Texas A&M University", "2023", "College Station, TX", NA,
  "Professional Wildlife Certification", "RWFM 481 - Texas A&M University", "Spring 2023", "College Station, TX", NA,
