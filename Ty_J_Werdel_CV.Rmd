...
\begin{cvmemb}
 \cvmem
    {Canadian Journal of Zoology, Frontiers in Ecology and the Environment, Journal of Mammalogy, PeerJ (\textit{2}), Science, Journal of Wildlife Management}
    {}
    {}
\end{cvmemb}
```
...
\begin{cvpress}
 \cvpres
    {Beast Feast Planning Committee (\textit{Nutria Specialist})}
    {RWFM}
    {2023 -- Present}
 \cvpres
