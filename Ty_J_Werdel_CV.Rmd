...
\begin{cvpubs}
    {
      \begin{cvetar}
      \item {Rooney, B., ...,\textbf{T.J. Werdel}, ..., and W.J. McShea (> 100 Co-Authors). \textbf{In-Press}. SNAPSHOT USA 2019–2023: The first five years of data from a coordinated camera trap survey of the United States. \textbf{\textit{Global Ecology and Biogeography}}.}
...
\begin{cvpubs}
    {
      \begin{cvetar}
      \item {Erdogan, O., M.I. Haque, H.A. Biswas, \textbf{T.J. Werdel}, and H. Mohammed. \textbf{2025}. An investigation of the osmotic effects on \textit{Aeromonas hydrophila}, the causative agent of motile \textit{aeromonas} septicemia. \textbf{\textit{Texas Aquaculture Association Annual Meeting, Port Lavaca, Texas}}.}
