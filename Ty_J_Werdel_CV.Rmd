...
profilepic: "TySuitHeadshot_Square.jpg"
...
\begin{cvpubs}
    {
      \begin{cvetar}
      \item {\textbf{Werdel, T.J.}, M. Fidino, C.W. Piper, A.M. Ricketts, M.S. Peek, and A.A Ahlers. \textbf{2025}. Influence of landscape composition on spatiotemporal interactions between sympatric canids. \textbf{\textit{Ecological Applications}} (Cover Article). \url{https://doi.org/10.1002/eap.70047}}
...
\begin{cvpubs}
    {
      \begin{cvetar}
      \item {Art, K.M.\textbf{*}, R.R. Lopez, E.H. Silvy, J.L. Dykes, and \textbf{T.J. Werdel}. \textbf{2025}. Eastern fox squirrel (\textit{Sciurus niger}) ecology and management. \textbf{\textit{Texas A{\&}M AgriLife Extension}}: RWFM-PU-426.}
      \end{cvetar}
    }
\end{cvpubs}
```
...
\begin{cvpubs}
    {
      \begin{cvetar}
      \item {\textbf{Werdel, T.J.} \textbf{2025}. SpatioTemporalCanids (Version 1.0.0). \textbf{\textit{Zenodo}}. \url{https://doi.org/10.5281/zenodo.15191398}}
      \end{cvetar}
    }
\end{cvpubs}
```
...
\begin{cvpubs}
    {
      ...
      \item {Matarrita-Cascante, D., \textbf{T.J. Werdel}, and C. Veintimilla. \textbf{In-Review}. Rural migration, urban values: contemporary threats and opportunities for wildlife ecosystem management. \textbf{\textit{Wildlife Letters}}.}
      \item {Matarrita-Cascante, D., S. McCord, R. Landaverde, C. Veintimilla, M. Treadwell, \textbf{T.J. Werdel}, J.M. Likins, R. Muhl, and J.D. Ulrich-Schad. \textbf{In-Review}. Amenity migration to working lands: factors influencing management decisions of beginning ranchers. \textbf{\textit{Agriculture and Human Values}}.}
      \end{cvetar}
    }
\end{cvpubs}
```
...
## *Graduate Student Committee Chair/Co-Chair* (*Graduated)
...
\begin{cvpress}
 \cvpres
    {Boone and Crockett Chair Search Committee}
    {RWFM}
    {2025 -- Present}
 \cvpres
