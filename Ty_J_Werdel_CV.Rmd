...
\begin{cvpubs}
    {
      \begin{cvetar}
        \item {Palomo-Muñoz, G., M. Fidino, \textbf{T.J. Werdel}, C.W. Piper, T. Gallo, M.S. Peek, A.M. Ricketts, and A.A. Ahlers. \textbf{In-Press}. Mesopredators have differing influences on prey habitat use and diet activity in a multipredator landscape. \textbf{\textit{Ecosphere}}.}
