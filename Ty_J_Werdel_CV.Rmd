...
profilepic: "TySuitHeadshot-2_Square.jpg"
...
# turn on figure cropping
knitr::opts_chunk$set(
  echo     = FALSE,
  warning  = FALSE,
  message  = FALSE,
  fig.crop = TRUE           # ← enable cropping
)

# tell R where Ghostscript lives:
Sys.setenv(
  R_GSCMD = "C:\\Program Files\\gs\\gs10.05.1\\bin\\gswin64.exe"
)
...
\begin{cvpubs}
    {
      \begin{cvetar}
      \item {\textbf{Werdel, T.J.}, M. Fidino, C.W. Piper, A.M. Ricketts, M.S. Peek, and A.A Ahlers. \textbf{2025}. Influence of landscape composition on spatiotemporal interactions between sympatric canids. \textbf{\textit{Ecological Applications}}. \url{https://doi.org/10.1002/eap.70047}}
